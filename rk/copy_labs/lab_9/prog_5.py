...
# n – количсетво строк матриц
# d – количество столбцов матрицы D
# z – количество столбцов матрицы Z
...
# list_G – массив G количества элементов матрицы D, превышающих сумму элементов матрицы Z 
# mx – максимальный элемент массива G
